...
function displayProduct(product) {
    ...
    for (let i = 0; i < product.length; i++) {
        box += `
        <div class="col-md-4">
        <div class="product bg-light-subtle shadow-lg rounded-2">
            <div class="title position-relative" style="background-image: url(${product[i].thumbnail});">
            <P  class="description bg-light">${product[i].description}</P>
          </div>
            <h5 class="p-2">${product[i].title}</h5>
...
// Perform search when user inputs in the search box
